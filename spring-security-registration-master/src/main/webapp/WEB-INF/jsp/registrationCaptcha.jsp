...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="org.baeldung.captcha.CaptchaService"%>
...
<body>
<c:out value="${captchaService.getReCaptchaSite()}"></c:out>
    <div class="container">
        <div >
           <h1 ><spring:message code="label.form.title"></spring:message></h1>
            ...
            <form action="/" method="POST" enctype="utf8">
                ...
                <div class="form-group row">
                    ...
                    <div class="g-recaptcha col-sm-5" data-sitekey='<c:out value="${captchaService.getReCaptchaSite()}"/>'  data-callback="onReCaptchaSuccess" data-expired-callback="onReCaptchaExpired"></div>
