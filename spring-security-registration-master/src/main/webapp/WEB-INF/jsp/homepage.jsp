...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="container">
		...
		<br /> <br />
	    <a href="/loggedUsers">
	    	<spring:message code="label.pages.users.message"></spring:message>
	    </a>
		<br />	    
	    <a href="/loggedUsersFromSessionRegistry">
	    	<spring:message code="label.pages.users.sessionregistry.message"></spring:message>
	    </a>
