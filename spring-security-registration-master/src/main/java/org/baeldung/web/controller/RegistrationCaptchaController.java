...
public class RegistrationCaptchaController {
    ...
    // Registration
    @RequestMapping(value="/registrationCaptcha", method = RequestMethod.GET)
    public String registrationCaptcha(Map<String, ICaptchaService> model){
    	model.put("captchaService", captchaService);
    	return "registrationCaptcha";
    }
    @RequestMapping(value = "/user/registrationCaptcha", method = RequestMethod.POST)
    //@RequestMapping(value = "/registrationCaptcha", method = RequestMethod.POST)
    @ResponseBody
