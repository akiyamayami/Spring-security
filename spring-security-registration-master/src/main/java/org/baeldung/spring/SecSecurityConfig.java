...
import org.baeldung.security.MyLogoutSuccessHandler;
        ...
        http
            ...
            .authorizeRequests()
                .antMatchers("/login*","/login*", "/logout*", "/signin/**", "/signup/**",
                        ...
                        "/user/changePassword*", "/emailError*", "/resources/**","/old/user/registration*","/successRegister*","/qrcode*","/favicon").permitAll()
